...
public abstract class ItemViewProvider<V extends BaseViewHolder, M> {
    ...
    @NonNull
    public abstract V onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, int type);
