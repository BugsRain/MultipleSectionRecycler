...
public class ItemViewProvider2 extends ItemViewProvider<ItemViewProvider2.ViewHolder, ArrayList<String>> {
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, int type) {
        return new ViewHolder(inflater.inflate(R.layout.viewhoder2, parent, false), type);
    }
