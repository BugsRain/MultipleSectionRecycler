...
public class ItemViewProvider1 extends ItemViewProvider<ItemViewProvider1.ViewHolder, ArrayList<String>> {
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, int type) {
        return new ViewHolder(inflater.inflate(R.layout.viewhoder1, parent, false), type);
    }
